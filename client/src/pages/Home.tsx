  ...
  return (
    <div className="class-site" style={{ "--hero-image": `url(${HERO_IMAGE_URL})` } as CSSProperties}>
      ...
      <main>
        ...
        <section className="gallery-section content-scene" id="gallery" aria-labelledby="gallery-title"><div className="geometry-layer gallery-geometry scroll-parallax" data-parallax="0.48" aria-hidden="true"><i /><i /><i /></div><div className="scene-title reveal-item"><OrbitMark /><h2 id="gallery-title">Galeri</h2></div><div className="gallery-marquee" aria-label="Arus foto Galeri XII-H"><div className="gallery-marquee__row gallery-marquee__row--top"><div className="gallery-marquee__track gallery-marquee__track--right">{galleryForward.map((item, index) => <button className="gallery-strip-card" style={{ "--reveal-delay": `${Math.min(index, 5) * 65}ms` } as CSSProperties} key={`forward-${index}`} type="button" onClick={() => setSelectedCard(`Foto ${item.code}`)} aria-label={`Buka foto ${item.code}`}><img src={item.image} alt="" loading="lazy" /><span>{item.code}</span></button>)}</div></div><div className="gallery-marquee__row gallery-marquee__row--middle"><div className="gallery-marquee__track gallery-marquee__track--left">{galleryBackward.map((item, index) => <button className="gallery-strip-card" style={{ "--reveal-delay": `${Math.min(index, 5) * 65 + 130}ms` } as CSSProperties} key={`middle-${index}`} type="button" onClick={() => setSelectedCard(`Foto ${item.code}`)} aria-label={`Buka foto ${item.code}`}><img src={item.image} alt="" loading="lazy" /><span>{item.code}</span></button>)}</div></div><div className="gallery-marquee__row gallery-marquee__row--bottom"><div className="gallery-marquee__track gallery-marquee__track--right gallery-marquee__track--slow">{galleryForward.map((item, index) => <button className="gallery-strip-card" style={{ "--reveal-delay": `${Math.min(index, 5) * 65 + 240}ms` } as CSSProperties} key={`bottom-${index}`} type="button" onClick={() => setSelectedCard(`Foto ${item.code}`)} aria-label={`Buka foto ${item.code}`}><img src={item.image} alt="" loading="lazy" /><span>{item.code}</span></button>)}</div></div></div></section>
